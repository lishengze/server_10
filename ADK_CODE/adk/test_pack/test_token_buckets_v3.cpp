...
void Stream(uint64_t* byte_counter, ConstRateCtrl* rate_ctrl)
{
    while (true)
    {
...
int main()
{
    ...
    ConstRateCtrl* const tb_temp = RateControl::GetInstance<rate_unit::Microsecond>((uint32_t)1024*4, (uint32_t)1);
