...
#include "property_container_pack.h"
#include <iostream>
...
void Property::SetValue(const string& key, const adk::Pointer& value)
{
    container_->SetValue(key, value);
}
...
void Property::SetValue(const string& key, const vector<adk::Pointer>& value)
{
    container_->SetValue(key, value);
}
...
adk::Pointer Property::GetPointerValue(const string& key) const
{
...
vector<adk::Pointer> Property::GetPointerVectorValue(const string& key) const
{
...
adk::Pointer Property::GetValue(const string& key, const adk::Pointer& default_value) const
{
    return container_->GetValue(key, default_value);
}
...
vector<adk::Pointer> Property::GetValue(
        const string& key,
        const vector<adk::Pointer>& default_value) const
{
    return container_->GetValue(key, default_value);
}
...
{
    return adk::PropertyContainer::GetPtree(property);
}
...
{
    adk::PropertyContainer::SetPtree(property, pt);
}
