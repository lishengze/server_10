...
* @date 2017-08-10
*/
#ifndef ADK_IMPL_BOOST_LOGGER_H_
#define ADK_IMPL_BOOST_LOGGER_H_
...
#include <boost/log/sinks.hpp>
    ...
    #define ADK_LOG_INIT(...) \
        do { \
            ADK_LOG_USE_LOGGER(new adk_impl::log::BoostLogger); \
            adk_impl::log::BoostLogger::Init(__VA_ARGS__); \
        } while (false)
...
namespace log
{
extern const char* GetCurrentLogFile();
class ADK_API BoostLogger : public Logger
{
public:
    BoostLogger();
