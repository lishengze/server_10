...
void ConsumerThreadMain(MPSCQueue<uint64_t>* mq, adk::SimpleEventManager* ev_man)
{
    uint64_t begin, end;
...
int main(int argc, char const *argv[])
{
    ...
    boost::thread consumer = boost::thread(boost::bind(ConsumerThreadMain, mq_p, &ev_man));
