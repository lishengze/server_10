...
public:
    int32_t OnMessage(Message* message) override
    {
        ...
        do 
        {
            ...
            {
                static_cast<CallbackType*>(this)->ProcessMsg(consume_data, data_len);
...
{
public:
    void ProcessMsg(const char* data, uint32_t data_len)
    {
        g_tcp_endpoint->SendMsg(data, data_len);
    }
};
