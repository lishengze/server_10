...
{   
    ...
    T v1 = adk::Random(std::numeric_limits<T>::min(), std::numeric_limits<T>::min());
    BOOST_CHECK_MESSAGE(v1 == std::numeric_limits<T>::min(), "value=" + std::to_string(v1));

    T v2 = adk::Random(std::numeric_limits<T>::max(), std::numeric_limits<T>::max());
    BOOST_CHECK_MESSAGE(v2 == std::numeric_limits<T>::max(), "value=" + std::to_string(v2));

    T v3 = adk::Random(std::numeric_limits<T>::min(), T(0));
    ...
    T v5 = adk::Random(std::numeric_limits<T>::min(), std::numeric_limits<T>::max());
