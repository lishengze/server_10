...
/***
         *** This file was generated at "2017-07-30 17:22:04"
         *** by:
...
Controls the aggregation node endianness
0: LITTLE_ENDIAN
1: BIG_ENDIAN */
	/* 0x0.0 - 0x0.0 */
	 u_int8_t endianness;
...
/*---------------- DWORD[1] (Offset 0x4) ----------------*/
	/* Description - Tree Identifier
Note that in Switch-IB2, the quotas are configured globally and 
...
/*---------------- DWORD[9] (Offset 0x24) ----------------*/
	/* Description - UD QPN for multicast */
	/* 0x24.0 - 0x24.23 */
	 u_int32_t ud_qpn;
/*---------------- DWORD[10] (Offset 0x28) ----------------*/
	/* Description - Maximum Groups
...
#define SMP_PORTINFOEXTENDED_SIZE    (0x10)
...
#define VS_DC_PAGE1LATESTVERSION_SIZE    (0x60)
...
#define VS_DIAGNOSTICDATA_SIZE    (0xd0)
